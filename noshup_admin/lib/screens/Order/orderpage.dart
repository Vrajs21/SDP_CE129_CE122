                    ...
                    child: ElevatedButton(
                      style: ButtonStyle(
                        backgroundColor: MaterialStateProperty.resolveWith<Color>(
                            ...
                            if (oid['is_RedPre']) return Colors.redAccent;
                            return Colors.grey;
                          },
                        ),
                      ),
                      onPressed: () => redPreparing_button(oid['orderID'], context),
                      onLongPress: () => redReverse_button(oid['orderID'], context),
                      child: Text(
                        "Preparing",
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      style: ButtonStyle(
                        backgroundColor: MaterialStateProperty.resolveWith<Color>(
                              (Set<MaterialState> states) {
                            if (oid['is_OrgReady']) return Colors.orange;
                            return Colors.grey;
                          },
                        ),
                      ),
                      onPressed: () => orgReady_button(oid['orderID'], context),
                      onLongPress: () => orgReverse_button(oid['orderID'], context),
                      child: Text(
                        "Ready to take",
                        style: TextStyle(fontSize: 10, color: Colors.white),
                      ),
